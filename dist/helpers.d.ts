import { CurrentState, DesiredState, Scaling, Usage } from './schemas';
...
export declare function aggregateUsageByService(usageData: Usage[]): Usage[];
export declare function calculate_scaling(data: {
    usage: Usage;
    service_spec: DockerService;
}[]): Effect.Effect<Scaling[], never, Config>;
