...
const placement_schema = Schema.optional(Schema.Struct({
...
export const service_mode_schema = Schema.Union(Schema.Struct({ Global: Schema.Struct({}) }), Schema.Struct({ Replicated: Schema.Struct({ Replicas: Schema.Number }) }));
