...
const node_status_schema = Schema.Union(Schema.Literal("ready"), Schema.Literal("down"), Schema.Literal("unknown"), Schema.Literal("disconnected"));
const node_availability_schema = Schema.Union(Schema.Literal("active"), Schema.Literal("pause"), Schema.Literal("drain"));
const manager_status_schema = Schema.Union(Schema.Literal("leader"), Schema.Literal("reachable"), Schema.Literal("unavailable"), Schema.Literal("worker"));
...
export const desired_state_schema = Schema.Union(Schema.Literal("Running"), Schema.Literal("Shutdown"), Schema.Literal("Unknown"));
export const current_state_schema = Schema.Union(Schema.Literal("Running"), Schema.Literal("Shutdown"), Schema.Literal("Failed"), Schema.Literal("Rejected"), Schema.Literal("Complete"), Schema.Literal("Orphaned"), Schema.Literal("Paused"), Schema.Literal("Pending"), Schema.Literal("Preparing"), Schema.Literal("Starting"), Schema.Literal("Removing"), Schema.Literal("Accepted"), Schema.Literal("New"), Schema.Literal("Allocated"), Schema.Literal("Assigned"), Schema.Literal("Ready"), Schema.Literal("Unknown"));
...
export const metrics_schema = Schema.Struct({
    ...
    value: Schema.Tuple(Schema.Number, // The timestamp
